...
<div class="background-image">
    <div
        ...
        <ul class="space-y-4 text-right uppercase animate__animated animate__fadeInLeft animate__slow">
    ...
    <div
        ...
        <ul class="space-y-4 text-right uppercase animate__animated animate__fadeInLeft animate__slow">
            ...
            <li><a href="#Mix & Mastering" class=" hover:bg-rosa hover:text-negro">.mix & mastering</a></li>
            <li><a href="#Sound Designer" class=" hover:bg-rosa hover:text-negro">.sound designer</a></li>
        </ul>
    </div>
