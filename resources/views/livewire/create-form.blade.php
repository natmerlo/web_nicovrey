<div class="px-4 mx-auto py-9 max-screen-2xl md:px-16 lg:px-24">
    <div>
        <h2 class="text-3xl font-semibold uppercase py-9 md:text-4xl font-roboto text-blanco">Cargar nuevo</h2>
    </div>
    <div>
            ...
            <div class="flex-col space-y-4">
                <div class="">
                    ...
                    <div id="categoria" name="categoria" class="block w-full px-3 py-2 font-varela border-blanco">
                        <div class="mb-2">
                            <input type="checkbox" id="productor" name="productor" value="1">
                            <label for="productor" class="ml-2 text-blanco">Productor</label>
                        </div>
                        <div class="mb-2">
                            <input type="checkbox" id="mix_mastering" name="mix_mastering" value="2">
                            <label for="mix_mastering" class="ml-2 text-blanco">Mix & Mastering</label>
                        </div>
                        <div class="mb-2">
                            <input type="checkbox" id="sound_designer" name="sound_designer" value="3">
