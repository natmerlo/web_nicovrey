<div class="{{$bg}} pb-20">
    <div class="max-w-screen-xl mx-auto py-16 pb-12 text-center md:px-28 md:text-start">
    ...
    <div class="flex flex-wrap justify-center gap-16 mx-auto ">
        @foreach($trabajos as $trabajo)
        <a href="#">
            <div class="max-w-[280px]">
                <img src="{{ asset('img/img_trabajos') . '/' . $trabajo->imagen }}" alt="">
                <div class="text-[18px] font-semibold font-roboto mt-3 text-center">
