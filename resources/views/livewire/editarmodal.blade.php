<div>
    ...
    <div id="static-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
        class="bg-[#0000008c] overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full max-h-full flex mt-[80px]">
        <div class="relative p-4 w-full max-w-4xl max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <h2 class="text-2xl font-bold font-roboto uppercase">
                        Nuevo registro
                    </h2>
                ...
                <!-- Modal body -->
                <div class="grid gap-6 lg:grid-cols-3 p-4 md:p-6">
                    <div class="flex-col space-y-4">
                        <div class="mb-5">
                            <label for="titulo" class="block mb-2 font-bold font-roboto">Título</label>
                            <input type="text" wire:model="titulo" id="titulo"
                                class="block w-full px-3 py-2 bg-gray-50 font-varela" placeholder="Ingresa el título" />
                            @error('titulo')
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" wire:model="descripcion" id="descripcion"
                                class="block w-full px-3 py-2 bg-gray-50 font-varela"
                    ...
                    <div class="lg:flex lg:justify-between">
                        <div class="flex flex-col">
                            ...
                            @else
                                <img class="object-cover" src="{{ asset('img/img_trabajos') . '/' . $imagenAntig }}" alt="">                                
                            @endif
                ...
                <!-- Modal footer -->
                <div class="flex items-center md:justify-end p-4 md:p-5 border-t border-gray-200 rounded-b gap-4">
                    <button wire:click="hideModal" type="button"
